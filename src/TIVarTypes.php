...
abstract class TIVarTypes
{
     ...
     *                          82, 83, 82A, 82+/83+, 84+, 84+CSE, 84+CE, 83PCE (see TIVersions).
     */
    ...
    {
        self::insertType('Unknown',                -1,  [ null,  null,  null,  null,  null,  null,  null,  null]);

        /* Standard types */
        self::insertType('Real',                 0x00,  ['82n', '83n', '8xn', '8xn', '8xn', '8xn', '8xn', '8xn']);
        self::insertType('RealList',             0x01,  ['82l', '83l', '8xl', '8xl', '8xl', '8xl', '8xl', '8xl']);
        self::insertType('Matrix',               0x02,  ['82m', '83m', '8xm', '8xm', '8xm', '8xm', '8xm', '8xm']);
        self::insertType('Equation',             0x03,  ['82y', '83y', '8xy', '8xy', '8xy', '8xy', '8xy', '8xy']);
        self::insertType('String',               0x04,  ['82s', '83s', '8xs', '8xs', '8xs', '8xs', '8xs', '8xs']);
        self::insertType('Program',              0x05,  ['82p', '83p', '8xp', '8xp', '8xp', '8xp', '8xp', '8xp']);
        self::insertType('ProtectedProgram',     0x06,  ['82p', '83p', '8xp', '8xp', '8xp', '8xp', '8xp', '8xp']);
        self::insertType('Picture',              0x07,  [ null,  null, '8xi', '8xi', '8xi', '8ci', '8ci', '8ci']);
        self::insertType('GraphDataBase',        0x08,  ['82d', '83d', '8xd', '8xd', '8xd', '8xd', '8xd', '8xd']);
//      self::insertType('WindowSettings',       0x0B,  ['82w', '83w', '8xw', '8xw', '8xw', '8xw', '8xw', '8xw']);
        self::insertType('Complex',              0x0C,  [ null, '83c', '8xc', '8xc', '8xc', '8xc', '8xc', '8xc']);
        self::insertType('ComplexList',          0x0D,  [ null, '83l', '8xl', '8xl', '8xl', '8xl', '8xl', '8xl']);
        self::insertType('WindowSettings',       0x0F,  ['82w', '83w', '8xw', '8xw', '8xw', '8xw', '8xw', '8xw']);
        self::insertType('RecallWindow',         0x10,  ['82z', '83z', '8xz', '8xz', '8xz', '8xz', '8xz', '8xz']);
        self::insertType('TableRange',           0x11,  ['82t', '83t', '8xt', '8xt', '8xt', '8xt', '8xt', '8xt']);
        self::insertType('Backup',               0x13,  ['82b', '83b',  null, '8xb', '8xb', '8cb',  null,  null]);
        ...
        self::insertType('RealFration',          0x18,  [ null,  null,  null, '8xn', '8xn', '8xn', '8xn', '8xn']);
        ...
        self::insertType('ExactComplexFrac',     0x1B,  [ null,  null,  null,  null,  null,  null,  null, '8xc']);
        self::insertType('ExactRealRadical',     0x1C,  [ null,  null,  null,  null,  null,  null,  null, '8xn']);
        self::insertType('ExactComplexRadical',  0x1D,  [ null,  null,  null,  null,  null,  null,  null, '8xc']);
        self::insertType('ExactComplexPi',       0x1E,  [ null,  null,  null,  null,  null,  null,  null, '8xc']);
        self::insertType('ExactComplexPiFrac',   0x1F,  [ null,  null,  null,  null,  null,  null,  null, '8xc']);
        self::insertType('ExactRealPi',          0x20,  [ null,  null,  null,  null,  null,  null,  null, '8xn']);
